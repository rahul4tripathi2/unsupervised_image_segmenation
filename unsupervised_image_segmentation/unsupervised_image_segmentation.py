...
# !python unsupervised_image_segmentation.py --input images/zebra.jpg --maxIter 10 --minLabels 4
...
# SLIC algorithm to generated labels
# https://www.youtube.com/watch?v=-hmUbB-Y8R0
